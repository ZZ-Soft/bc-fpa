...
<xsl:stylesheet
	...
	<xsl:choose>
      <xsl:when test="$Natura">
		...
		<xsl:if test="number($IVA)" >
			<br/><xsl:value-of select="format-number(number($IVA),  '###.###.##0,00', 'euro')" />
		</xsl:if>
      </xsl:when>
      <xsl:otherwise>
        <xsl:if test="$IVA">
          <xsl:value-of select="format-number(number($IVA),  '###.###.##0,00', 'euro')" />
        </xsl:if>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template name="FormatSconto">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:if test="$importo">
          <xsl:value-of select="format-number(number($importo),  '###.###.##0,00######', 'euro')" />
        </xsl:if>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:text> </xsl:text>
              ...
              <xsl:if test=" translate( TipoDato,
                ...
                <xsl:if test="RiferimentoNumero">
                  <div class="tx-xsmall">
                    ...
                    <xsl:value-of select="format-number(number(RiferimentoNumero),  '###.###.##0,00######', 'euro')" />
                  </div>
                </xsl:if>
          ...
          <td class="import2" >
            <xsl:if test="Quantita">
              <xsl:if test="number(Quantita)">
                <xsl:value-of select="format-number(number(Quantita),  '###.###.##0,00######', 'euro')" />
              </xsl:if>
            </xsl:if>
          </td>
          ...
          <td class="import" >
            <xsl:if test="PrezzoUnitario">
              <xsl:if test="number(PrezzoUnitario)">
                ...
                <xsl:value-of select="format-number(number(PrezzoUnitario),  '###.###.##0,00######', 'euro')" />
              </xsl:if>
            </xsl:if>
          </td>
          ...
          <td>
            <xsl:if test="PrezzoTotale">
              <xsl:if test="number(PrezzoTotale)">
                ...
                <div class="import">
                  <xsl:value-of select="format-number(number(PrezzoTotale),  '###.###.##0,00######', 'euro')" />
                </div>
              </xsl:if>
        ...
        <tr>
          ...
          <td class="import" >
            <xsl:if test="AliquotaRitenuta">
              <xsl:value-of select="format-number(number(AliquotaRitenuta),  '###.###.##0,00', 'euro')" />
            </xsl:if>
          ...
          <td class="import" >
            <xsl:if test="ImportoRitenuta">
              ...
              <xsl:value-of select="format-number(number(ImportoRitenuta),  '###.###.##0,00', 'euro')" />
  ...
  <xsl:template match="DettaglioPagamento">
    ...
    <xsl:if test="DataLimitePagamentoAnticipato or ScontoPagamentoAnticipato">
      ...
      <xsl:if test="ScontoPagamentoAnticipato">
        Sconto anticipato
        <xsl:value-of select="format-number(number(ScontoPagamentoAnticipato),  '###.###.##0,00', 'euro')" />
      </xsl:if>
      <br/>
    </xsl:if>
    ...
    <xsl:if test="DataDecorrenzaPenale or PenalitaPagamentiRitardati">
      ...
      <xsl:if test="PenalitaPagamentiRitardati">
        Importo penale
        <xsl:value-of select="format-number(number(PenalitaPagamentiRitardati),  '###.###.##0,00', 'euro')" />
      </xsl:if>
                    ...
                    <tr>
                      ...
                      <td class="import" >
                        ...
                        <xsl:if test="DatiIVA/Imposta">
                          <xsl:value-of select="format-number(number(DatiIVA/Imposta),  '###.###.##0,00', 'euro')" />
                        </xsl:if>
                      </td>
                      <td class="import" >
                      ...
                      <tr>
                        ...
                        <td class="import">
                          <xsl:if test="ImponibileCassa">
                            <xsl:value-of select="format-number(number(ImponibileCassa),  '###.###.##0,00', 'euro')" />
                          </xsl:if>
                        </td>
                        ...
                        <td class="import">
                          <xsl:if test="AlCassa">
                            ...
                            <xsl:value-of select="format-number(number(AlCassa),  '###.###.##0,00', 'euro')" />
                          ...
                          <xsl:choose>
                            ...
                            <xsl:otherwise>
                              <xsl:if test="AliquotaIVA">
                                ...
                                <xsl:value-of select="format-number(number(AliquotaIVA),  '###.###.##0,00', 'euro')" />
                        ...
                        <td class="import">
                          <xsl:if test="ImportoContributoCassa">
                            ...
                            <xsl:value-of select="format-number(number(ImportoContributoCassa),  '###.###.##0,00', 'euro')" />
                      ...
                      <tr>
                        ...
                        <td class="import">
                          ...
                          <xsl:if test="SpeseAccessorie">
                            <xsl:value-of select="format-number(number(SpeseAccessorie),  '###.###.##0,00', 'euro')" />
                          </xsl:if>
                        </td>
                        ...
                        <xsl:if test="Arrotondamento">
                          <xsl:value-of select="format-number(number(Arrotondamento),  '###.###.##0,00', 'euro')" />
                        </xsl:if>
                      </td>
                        <td  colspan="2" class="import" >

                          <xsl:if test="ImponibileImporto">
                            <xsl:value-of select="format-number(number(ImponibileImporto),  '###.###.##0,00', 'euro')" />
                          </xsl:if>
                        </td>
                        ...
                        <td colspan="2"  class="import" >
                          ...
                          <xsl:if test="Imposta">
                            ...
                            <xsl:choose>
                              ...
                              <xsl:otherwise>
                                <xsl:value-of select="format-number(number(Imposta),  '###.###.##0,00', 'euro')" />
                              </xsl:otherwise>
                            </xsl:choose>
                  ...
                  <tr >
                    <td colspan="2" class="import" >
					 ...
					 <xsl:if test="DatiGenerali/DatiGeneraliDocumento/DatiBollo">
						...
						<xsl:when test="DatiGenerali/DatiGeneraliDocumento/DatiBollo/ImportoBollo">
							<xsl:value-of select="format-number(number(DatiGenerali/DatiGeneraliDocumento/DatiBollo/ImportoBollo),  '###.###.##0,00', 'euro')" />
						</xsl:when>
					...
					<td class="import">
                      ...
                      <xsl:if test="DatiGenerali/DatiGeneraliDocumento/Arrotondamento">
                        ...
                        <xsl:value-of select="format-number(number(DatiGenerali/DatiGeneraliDocumento/Arrotondamento),  '###.###.##0,00', 'euro')" />
                    ...
                    <td colspan="4" class="import">
                      ...
                      <xsl:if test="DatiGenerali/DatiGeneraliDocumento/ImportoTotaleDocumento">
                        ...
                        <xsl:value-of select="format-number(number(DatiGenerali/DatiGeneraliDocumento/ImportoTotaleDocumento),  '###.###.##0,00', 'euro')" />
                      ...
                      <tr>
                        ...
                        <td class="import">
                          ...
                          <xsl:if test="ImportoPagamento">
                            ...
                            <xsl:value-of select="format-number(number(ImportoPagamento),  '###.###.##0,00', 'euro')" />
